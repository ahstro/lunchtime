																			...
																			_1: {
																				...
																				_1: {
																					...
																					_0: A3(
																						...
																						_rtfeldman$elm_css$Css$hex('a7d7f9')),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
																	...
																	_ahstro$lunchtime$Style$Diff,
																	{
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_1: {
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$marginRight(changePadding),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
																	...
																	_0: A2(
																		...
																		_ahstro$lunchtime$Style$Green,
																		{
																			...
																			_0: _rtfeldman$elm_css$Css$color(
																				_rtfeldman$elm_css$Css$hex('02660c')),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																			...
																			_1: {
																				...
																				_0: A2(
																					...
																					_ahstro$lunchtime$Style$Red,
																					{
																						ctor: '::',
																						_0: _rtfeldman$elm_css$Css$color(
																							_rtfeldman$elm_css$Css$hex('ba0000')),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$checked(chckd),
						_1: {
							ctor: '::',
...
var _ahstro$lunchtime$Lunchtime$userDot = function (change) {
	...
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$title(userName),
				_1: {
					ctor: '::',
...
if (typeof _ahstro$lunchtime$Lunchtime$main !== 'undefined') {
    _ahstro$lunchtime$Lunchtime$main(Elm['Lunchtime'], 'Lunchtime', undefined);
}
